...
class AiEditPage extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _AiEditPageState();
}

class _AiEditPageState extends StateMVC<AiEditPage> {
  _AiEditPageState() : super(AiWriteEditController()) {
